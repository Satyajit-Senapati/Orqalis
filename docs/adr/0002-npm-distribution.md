...
The CLI runs on demand. Local UI/API hosting is terminal-owned and shuts down with
its command; npm installation registers no Windows service or autostart entry.
